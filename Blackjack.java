...
public static void main(String[] args){
    ...
    while(cash>0){
        ...
        else
        {
            ...
            {
                Hit(deck, hand);
                System.out.println("Your hand is now:");//Displays the users hand after a hit.
                System.out.println(hand);
            ...
            if(hitter.equals("stand"))//lets the user stand.
            {
                ...
                System.out.println("");
                System.out.println("Here is the dealer's hand:");//Displays the dealers hand.
                dealer.showHand();
	...
	//Adds a card top the users hand and calculates, aces are taken into account.
